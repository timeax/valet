...
const sass_to_lightening_1 = require("./sass-to-lightening");
const csr_1 = __importDefault(require("./csr"));
...
(async () => {
    ...
    (0, sass_to_lightening_1.createSassCompilerCommand)(program);
    program
        .command("list")
