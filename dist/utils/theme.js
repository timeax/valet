...
exports.updateThemeBlock = updateThemeBlock;
exports.replaceThemeBlock = replaceThemeBlock;
function updateThemeBlock(cssContent, options) {
...
function replaceThemeBlock(cssContent, newThemeBlock) {
